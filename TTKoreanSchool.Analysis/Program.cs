...
namespace TTKoreanSchool.Analysis
{
    class Program
    {
            ...
            var projects = new List<Solution> {
                ...
                new Solution {
                    ...
                    ProjectFiles = new List<string> {
                        Path.Combine(path, "TTKoreanSchool.Android/TTKoreanSchool.Android.csproj"),
                        Path.Combine(path, "TTKoreanSchool/TTKoreanSchool.csproj")
                    },
                },
                ...
                new Solution {
                    Name = "iOS",
                    ProjectFiles = new List<string> {
                        Path.Combine(path, "TTKoreanSchool.iOS/TTKoreanSchool.iOS.csproj"),
                        Path.Combine(path, "TTKoreanSchool/TTKoreanSchool.csproj")
                    },
                },
